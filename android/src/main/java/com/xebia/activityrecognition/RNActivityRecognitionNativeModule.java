...
public class RNActivityRecognitionNativeModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        constants.put("ACTIVITY_STILL", DetectedActivity.STILL);
        constants.put("ACTIVITY_WALKING", DetectedActivity.WALKING);
        constants.put("ACTIVITY_IN_VEHICLE", DetectedActivity.IN_VEHICLE);
